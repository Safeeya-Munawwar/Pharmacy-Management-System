            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='edit_medicine.php?medicine_id=" . $row['medicine_id'] . "' class='btn btn-warning'>Edit</a>
                                <a href='?delete=" . $row['medicine_id'] . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this medicine?\")'>Delete</a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
